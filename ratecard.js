...
function handleInvoiceData(objectId) {
 ...
 // Fetch your contract data and populate the select dropdown
    fetch(`https://cleanstation.backendless.app/api/services/Brand/BrandContract?User_id=${objctID}`, {
      method: "GET",
      headers: {
          "Content-type": "application/json; charset=UTF-8",
      },
      ...
      .then((response) => response.json())
      .then((data) => {
          const contractDropdown = document.getElementById("contractSelect");
          localStorage.setItem("contractSelect", data.objectId);
    ...
    $("#CreateNewAuditButton").click(function () {
      ...
      let contractSelect =  $("#contractSelect").val();
      ...
      let requestData = {
        ...
        Fulfillment_Contracts: contractSelect,
      };
