...
async function setAuditDataInFields(objectId) {
    try {
        ...
        if (auditData.length > 0) {
            ...
            document.getElementById('Picker_Per_Order').innerHTML = auditData[0].Invoice_dashboard.Picker_Per_Order || 0;
            ...
            document.getElementById('Shipping_Cost_Per_Order').innerHTML = auditData[0].Invoice_dashboard.Shipping_Cost_Per_Order || 0;
            document.getElementById('Fulfillment_Cost').innerHTML = auditData[0].Invoice_dashboard.Fulfillment_Cost || 0;
            document.getElementById('Fulfillment_Cost_Per_Order').innerHTML = auditData[0].Invoice_dashboard.Fulfillment_Cost_Per_Order || 0;
            document.getElementById('Outbound_Cost').innerHTML = auditData[0].Invoice_dashboard.Outbound_Cost || 0;
            document.getElementById('Outbound_Cost_Per_Order').innerHTML = auditData[0].Invoice_dashboard.Outbound_Cost_Per_Order || 0;
            document.getElementById('Shipping_Weight').innerHTML = auditData[0].Invoice_dashboard.Shipping_Weight || 0;
            document.getElementById('Shipping_Weight_Per_Order').innerHTML = auditData[0].Invoice_dashboard.Shipping_Weight_Per_Order || 0;
            ...
            document.getElementById('Domestic.Shipping_Cost_Per_Order').innerHTML = auditData[0].Invoice_dashboard.Domestic.Shipping_Cost_Per_Order || 0;
            document.getElementById('Domestic.Weight').innerHTML = auditData[0].Invoice_dashboard.Domestic.Weight || 0;
            document.getElementById('Domestic.Weight_Per_Order').innerHTML = auditData[0].Invoice_dashboard.Domestic.Weight_Per_Order || 0;
            ...
            document.getElementById('International.Shipping_Cost_Per_Order').innerHTML = auditData[0].Invoice_dashboard.International.Shipping_Cost_Per_Order || 0;
            document.getElementById('International.Weight').innerHTML = auditData[0].Invoice_dashboard.International.Weight || 0;
            document.getElementById('International.Weight_Per_Order').innerHTML = auditData[0].Invoice_dashboard.International.Weight_Per_Order || 0;
...
getData();
      ...
      async function getData() {
        try {
          const response = await fetch('https://cleanstation.backendless.app/api/services/Audit/InvoiceToAudit?Id=0A9917CC-ED77-4795-9B2C-347F2F07A4D4');
          if (!response.ok) {
