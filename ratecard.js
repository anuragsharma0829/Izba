...
async function setAuditDataInFields(objectId) {
    try {
        ...
        if (auditData.length > 0) {
            ...
            document.getElementById('No_of_orders').value = auditData.Invoice_dashboard.No_of_orders;
            document.getElementById('Picks').value = audit.Picks;
            document.getElementById('Packages').value = audit.Packages;
            document.getElementById('Picker_Per_Order').value = audit.Picker_Per_Order;
            document.getElementById('Packages_Per_Order').value = audit.Packages_Per_Order;
            document.getElementById('Shipping_Cost').value = audit.Shipping_Cost;
            document.getElementById('Shipping_Cost_Per_Order').value = audit.Shipping_Cost_Per_Order;
            document.getElementById('Fulfillment_Cost').value = audit.Fulfillment_Cost;
            document.getElementById('Fulfillment_Cost_Per_Order').value = audit.Fulfillment_Cost_Per_Order;
            document.getElementById('Outbound_Cost').value = audit.Outbound_Cost;
            document.getElementById('Outbound_Cost_Per_Order').value = audit.Outbound_Cost_Per_Order;
            document.getElementById('Shipping_Weight').value = audit.Shipping_Weight;
            document.getElementById('Shipping_Weight_Per_Order').value = audit.Shipping_Weight_Per_Order;
            document.getElementById('Shipping_Weight_Unit').value = audit.Shipping_Weight_Unit;
        } else {
