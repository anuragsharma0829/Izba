...
document.addEventListener("DOMContentLoaded", function () {
    ...
    navLinks.forEach(function (link) {
        link.style.display = "inline"; // Display as inline to show only text
        link.style.padding = "0"; // Remove padding if not needed
        link.style.color = "#000"; // Set the desired text color
        link.style.textDecoration = "none"; // Remove text decoration
        link.style.transition = "none"; // Remove any transition effects
    });
});
