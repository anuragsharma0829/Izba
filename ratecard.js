...
async function setAuditDataInFields(objectId) {
    try {
        ...
        if (auditData.length > 0) {
            ...
            document.getElementById('No_of_orders').innerHTML = audit.No_of_orders;
            document.getElementById('Picks').innerHTML = audit.Picks;
            document.getElementById('Packages').innerHTML = audit.Packages;
            document.getElementById('Picker_Per_Order').innerHTML = audit.Picker_Per_Order;
            document.getElementById('Packages_Per_Order').innerHTML = audit.Packages_Per_Order;
            document.getElementById('Shipping_Cost').innerHTML = audit.Shipping_Cost;
            document.getElementById('Shipping_Cost_Per_Order').innerHTML = audit.Shipping_Cost_Per_Order;
            document.getElementById('Fulfillment_Cost').innerHTML = audit.Fulfillment_Cost;
            document.getElementById('Fulfillment_Cost_Per_Order').innerHTML = audit.Fulfillment_Cost_Per_Order;
            document.getElementById('Outbound_Cost').innerHTML = audit.Outbound_Cost;
            document.getElementById('Outbound_Cost_Per_Order').innerHTML = audit.Outbound_Cost_Per_Order;
            document.getElementById('Shipping_Weight').innerHTML = audit.Shipping_Weight;
            document.getElementById('Shipping_Weight_Per_Order').value = audit.Shipping_Weight_Per_Order;
            document.getElementById('Shipping_Weight_Unit').innerHTML = audit.Shipping_Weight_Unit;
        } else {
