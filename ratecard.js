...
async function setAuditDataInFields(objectId) {
    try {
        ...
        if (auditData.length > 0 && auditData.Status === "Completed") {
      
            // Set data in the fields
            
            document.getElementById('No_of_orders').innerHTML = auditData[0].Invoice_dashboard.No_of_orders || 0;
            document.getElementById('Picks').innerHTML = auditData[0].Invoice_dashboard.Picks || 0;
            document.getElementById('Packages').innerHTML = auditData[0].Invoice_dashboard.Packages || 0;
            document.getElementById('Picker_Per_Order').innerHTML = auditData[0].Invoice_dashboard.Picker_Per_Order.toFixed(3) || 0 ;
            document.getElementById('Packages_Per_Order').innerHTML = auditData[0].Invoice_dashboard.Packages_Per_Order || 0;
            document.getElementById('Shipping_Cost').innerHTML = auditData[0].Invoice_dashboard.Shipping_Cost || 0;
            document.getElementById('Shipping_Cost_Per_Order').innerHTML = auditData[0].Invoice_dashboard.Shipping_Cost_Per_Order.toFixed(3) || 0;
            document.getElementById('Fulfillment_Cost').innerHTML = auditData[0].Invoice_dashboard.Fulfillment_Cost || 0;
            document.getElementById('Fulfillment_Cost_Per_Order').innerHTML = auditData[0].Invoice_dashboard.Fulfillment_Cost_Per_Order.toFixed(3) || 0;
            document.getElementById('Outbound_Cost').innerHTML = auditData[0].Invoice_dashboard.Outbound_Cost || 0;
            document.getElementById('Outbound_Cost_Per_Order').innerHTML = auditData[0].Invoice_dashboard.Outbound_Cost_Per_Order.toFixed(3) || 0;
            document.getElementById('Shipping_Weight').innerHTML = auditData[0].Invoice_dashboard.Shipping_Weight || 0;
            document.getElementById('Shipping_Weight_Per_Order').innerHTML = auditData[0].Invoice_dashboard.Shipping_Weight_Per_Order.toFixed(3) || 0;
            document.getElementById('Shipping_Weight_Unit').innerHTML = auditData[0].Invoice_dashboard.Shipping_Weight_Unit || 0;


            // Domestic Data
            document.getElementById('Domestic.Orders').innerHTML = auditData[0].Invoice_dashboard.Domestic.Orders || 0;
            document.getElementById('Domestic.Shipping_Cost').innerHTML = auditData[0].Invoice_dashboard.Domestic.Shipping_Cost || 0;
            document.getElementById('Domestic.Shipping_Cost_Per_Order').innerHTML = auditData[0].Invoice_dashboard.Domestic.Shipping_Cost_Per_Order.toFixed(3) || 0;
            document.getElementById('Domestic.Weight').innerHTML = auditData[0].Invoice_dashboard.Domestic.Weight || 0;
            document.getElementById('Domestic.Weight_Per_Order').innerHTML = auditData[0].Invoice_dashboard.Domestic.Weight_Per_Order.toFixed(3) || 0;
            document.getElementById('Domestic.Weight_Unit').innerHTML = auditData[0].Invoice_dashboard.Domestic.Weight_Unit || 0;
            
            // International Data
            document.getElementById('International.Orders').innerHTML = auditData[0].Invoice_dashboard.International.Orders || 0;
            document.getElementById('International.Shipping_Cost').innerHTML = auditData[0].Invoice_dashboard.International.Shipping_Cost || 0;
            document.getElementById('International.Shipping_Cost_Per_Order').innerHTML = auditData[0].Invoice_dashboard.International.Shipping_Cost_Per_Order.toFixed(3) || 0;
            document.getElementById('International.Weight').innerHTML = auditData[0].Invoice_dashboard.International.Weight || 0;
            document.getElementById('International.Weight_Per_Order').innerHTML = auditData[0].Invoice_dashboard.International.Weight_Per_Order.toFixed(3) || 0;
            document.getElementById('International.Weight_Unit').innerHTML = auditData[0].Invoice_dashboard.International.Weight_Unit || 0;
 
            // Storage Data
            document.getElementById('Storage_Cost').innerHTML = auditData[0].Storage_dashboard.Storage_Cost || 0;
            document.getElementById('Storage_Cost_Per_Order').innerHTML = auditData[0].Storage_dashboard.Storage_Cost_Per_Order.toFixed(3) || 0; 

        } else {
          document.getElementById('auditStatus').innerHTML = auditData[0].Status || 0;
...
async function getData() {
  try {
    ...
    const totalbaseorder = data[0].Invoice_dashboard.Service || [];
    ...
    if (totalbaseorder.length === 0) {
      ...
      totalbaseorder.forEach(item => {
        ...
        const percentageOfOrders = ((totalOrders / data[0].Invoice_dashboard.No_of_orders) * 100).toFixed(2);
