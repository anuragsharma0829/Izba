...
async function setAuditDataInFields(objectId) {
    try {
        ...
        if (auditData.length > 0) {
            ...
            const audit = auditData[0]; // Assuming you want to set data from the first record

            // Set data in the fields
            document.getElementById('No_of_orders').value = auditData[0].Invoice_dashboard.No_of_orders || 0;
            document.getElementById('Picks').value = auditData[0].Invoice_dashboard.Picks || 0;
            document.getElementById('Packages').value = auditData[0].Invoice_dashboard.Packages || 0;
            document.getElementById('Picker_Per_Order').value = auditData[0].Invoice_dashboard.Picker_Per_Order || 0;
            document.getElementById('Packages_Per_Order').value = auditData[0].Invoice_dashboard.Packages_Per_Order || 0;
            document.getElementById('Shipping_Cost').value = auditData[0].Invoice_dashboard.Shipping_Cost || 0;
            document.getElementById('Shipping_Cost_Per_Order').value = auditData[0].Invoice_dashboard.Shipping_Cost_Per_Order || 0;
            document.getElementById('Fulfillment_Cost').value = auditData[0].Invoice_dashboard.Fulfillment_Cost || 0;
            document.getElementById('Fulfillment_Cost_Per_Order').value = auditData[0].Invoice_dashboard.Fulfillment_Cost_Per_Order || 0;
            document.getElementById('Outbound_Cost').value = auditData[0].Invoice_dashboard.Outbound_Cost || 0;
            document.getElementById('Outbound_Cost_Per_Order').value = auditData[0].Invoice_dashboard.Outbound_Cost_Per_Order || 0;
            document.getElementById('Shipping_Weight').value = auditData[0].Invoice_dashboard.Shipping_Weight || 0;
            document.getElementById('Shipping_Weight_Per_Order').value = auditData[0].Invoice_dashboard.Shipping_Weight_Per_Order || 0;
            document.getElementById('Shipping_Weight_Unit').value = auditData[0].Invoice_dashboard.Shipping_Weight_Unit || 0;
        } else {
