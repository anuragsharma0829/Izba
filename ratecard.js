...
async function setAuditDataInFields(objectId) {
    try {
        ...
        if (auditData) {
            ...
            // Audit Status
            var auditStatusColor = auditData.Status === "Completed" ? "green" : auditData.Status === "Ready for Audit" ? "orange" : "red";
            document.getElementById('auditStatusDisplay').innerHTML = auditStatusColor;
