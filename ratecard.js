...
async function setAuditDataInFields(objectId) {
    try {
        ...
        if (auditData.length > 0) {
            ...
            // Domestic Data
            document.getElementById('Domestic.Orders').innerHTML = auditData[0].Domestic.Domestic.Orders || 0;
            document.getElementById('Domestic.Shipping_Cost').innerHTML = auditData[0].Domestic.Domestic.Shipping_Cost || 0;
            document.getElementById('Domestic.Shipping_Cost_Per_Order').innerHTML = auditData[0].Domestic.Domestic.Shipping_Cost_Per_Order || 0;
            document.getElementById('Domestic.Weight').innerHTML = auditData[0].Domestic.Domestic.Weight || 0;
            document.getElementById('Domestic.Weight_Per_Order').innerHTML = auditData[0].Domestic.Domestic.Weight_Per_Order || 0;
            document.getElementById('Domestic.Weight_Unit').innerHTML = auditData[0].Domestic.Domestic.Weight_Unit || 0;
            
            // International Data
            document.getElementById('International.Orders').innerHTML = auditData[0].International.International.Orders || 0;
            document.getElementById('International.Shipping_Cost').innerHTML = auditData[0].International.International.Shipping_Cost || 0;
            document.getElementById('International.Shipping_Cost_Per_Order').innerHTML = auditData[0].International.International.Shipping_Cost_Per_Order || 0;
            document.getElementById('International.Weight').innerHTML = auditData[0].International.International.Weight || 0;
            document.getElementById('International.Weight_Per_Order').innerHTML = auditData[0].International.International.Weight_Per_Order || 0;
            document.getElementById('International.Weight_Unit').innerHTML = auditData[0].International.International.Weight_Unit || 0;
