    ...
    if (brandNameInput !== "") {
      ...
      fetch("https://cleanstation.backendless.app/api/data/Brand", {
        ...
        .then((brandData) => {
          ...
          // Create the Fulfillment Contract object
          let fulfillmentContract = {
            Labor_Warehouse_Rate: 33,
            Storage_Per_Pallet: 33,
            FC_Name: null,
            Base_Per_Return_Fee: 333,
            Contract_File: null,
            Contract_Start: null,
            Order_Cancellation_Fee: null,
            __Contract_Length_Years: null,
            ownerId: null,
            End_Date: 1690329600000,
            Labor_OT_Rate: 33,
            Storage_Per_Bin: 33,
            International_Surcharge_Fee: null,
            __Setup_Fee: null,
            Labeling_Barcoding_Fee: null,
            Minimum_Fee: 33,
            Extra_Unit_Fee: null,
            Management_Fee: 33,
            Contract_End: null,
            ___class: "Fulfillment_Contract",
            Base_Per_Order_Fee: 33,
            Fulfillment_Contract_Field: null,
            Start_Date: 1689724800000,
            objectId: "07C35CB1-3156-4A31-B729-318477E3F3A0",
            created: 1689590153976,
            Manifest_Fee: 0,
            Labor_IT_Rate: 33,
            Contract_name: null,
            Additional_Pick_Fee: 33,
            Receipt_Per_Case_Fee: 33,
            Storage_Rate_Type: null,
            Insert_Fee: null,
            Storage_Per_Shelf: 33,
            Extra_SKU_Fee: null,
            __Payment_Terms: null,
            __Doc_Fee_Per_BOL: null,
            Additional_Pick_Kit: 33,
            Receipt_Per_Pallet_Fee: 33,
            updated: null,
            Brand: {
              ___ref: "Brand:" + brandData.objectId,
            }, // Establishing the relationship using object reference
          };
