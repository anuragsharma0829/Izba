  ...
  $(document).ready(function () {
    $("#gotoEstimateDetail").click(function () {
      ...
      let estimatorDetails = {
        ReceiptCase: palletsReceived,
        ReceiptCase: casesReceived,
        Pallets: palletStorage,
        Shelfs: shelfStorage,
        Bins: binStorage,
        TotalOrders: baseOrders,
        ExtraPicks: basketSize,
        Returns: baseReturns,
        KitsBuilt: kitsCreated,
        WHHours: warehouseHours,
        OTHours: otHours,
        ITHours: itHours,
      };
      ...
      // Call API
      fetch(
        "https://cleanstation.backendless.app/api/data/data/Estimate",
        {
          method: "POST",
...
function handleEstimateId(id) {
  console.log("Retrieved Estimator:", id);
   ...
   // Handle relation
      ...
      console.log("object BrandRelation Ka", BrandRelation);
      console.log("postId aa gayi", postId);
      fetch(
