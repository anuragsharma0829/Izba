        ...
        .then((data) => {
          ...
          fetch(`https://cleanstation.backendless.app/api/data/Fulfillment_Contract/${fcobjId}`)
            ...
            .then((data) => {
              ...
              // Log the fulfillment contract data
              console.log("Fulfillment Contract data-------:");
              console.log("Receipt_Per_Pallet_Fee---------:", Storage_Per_Pallet);
              console.log("Receipt_Per_Case_Fee--------:", Storage_Per_Shelf);
              console.log("Base_Per_Return_Fee------:", Storage_Per_Bin);
              // console.log("Additional_Pick_Kit:", Additional_Pick_Kit);
              ...
              fetch(`https://cleanstation.backendless.app/api/data/Estimate/${EstimateId}`)
                ...
                .then((data) => {
                  ...
                  console.log("Fulfillment Contract data>>>-------:");
              console.log("Receipt_Per_Pallet_Fee--------->>>:", Pallets);
              console.log("Receipt_Per_Case_Fee-------->>>:", Shelfs);
              console.log("Base_Per_Return_Fee------<<<<:", Bins);
