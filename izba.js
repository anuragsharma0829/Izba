...
function calculation() {
  ...
  document.getElementById("gotoEstimateDetail").addEventListener("click", () => {
    // Brand data
    fetch(`https://cleanstation.backendless.app/api/data/Brand/${postId}`)
      .then((brandResponse) => brandResponse.json())
      .then((brandData) => {
    ...
    fetch(`https://cleanstation.backendless.app/api/data/Fulfillment_Contract/${fcobjId}`)
      .then((fulfillmentResponse) => fulfillmentResponse.json())
    ...
    fetch(`https://cleanstation.backendless.app/api/data/Estimate/${EstimatPostid}?loadRelations=Fulfillment_Contract`)
      .then((estimateResponse) => estimateResponse.json())
      .then((estimateData) => {
