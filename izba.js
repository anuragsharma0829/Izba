...
document.getElementById("SigninButton").addEventListener("click", function () {
  $("#registrationSectionId").hide();
  var uemil = document.getElementById("sign-inEmail-Days").value;
  var Password = document.getElementById("sign-inPassword").value;

  // Login section 
  var loginUrl = 'https://api.backendless.com/{YOUR-APP-ID}/{YOUR-REST-API-KEY}/users/login';
