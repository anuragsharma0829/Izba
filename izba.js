...
$("#goToReciving").click(function () {
  ...
  if (centers.trim() === "") {
    // Handle centers validation here if needed
    // You can display an error message for centers as well.
    // Example: const centersError = document.getElementById("centersError");
    // centersError.style.display = "block";
    // isValid = false;
  }

  if (isValid) {
    // Your code to proceed when the input is valid
    ...
    // Assuming enableTabAndTriggerClick is a valid function
