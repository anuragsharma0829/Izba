  ...
  $(document).ready(function () {
    ...
    $("#gotoEstimateDetail").click(function () {
      ...
      if (storagePerPalletValue === "") {
        // If the storagePerPalletInput is empty, disable the PalletStorageInput
        $("#PalletStorageInput").prop("disabled", true);
      } else {
        // If the storagePerPalletInput has a value, enable the PalletStorageInput
        $("#PalletStorageInput").prop("disabled", false);
      }
