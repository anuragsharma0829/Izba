...
function calculation() {
  ...
  fetch(`https://cleanstation.backendless.app/api/data/Brand/${postId}`)
    ...
    .then((brandData) => {
      ...
      // Fulfillment data
      return fetch(`https://cleanstation.backendless.app/api/data/Fulfillment_Contract/${fcobjId}`)
        ...
        .then((fulfillmentData) => {
          ...
          // Estimator data
          return fetch(`https://cleanstation.backendless.app/api/data/Estimate/${EstimatPostid}?loadRelations=Fulfillment_Contract`)
