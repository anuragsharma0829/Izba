    ...
    fetch(
      ...
      fetch(
        ...
        $("#FinalupdateButton").click(function () {
          ...
          const startInputValue = document.getElementById("updatestart").value;
          const endInputValue = document.getElementById("updateEnddate").value;
          const updatedData = {
            // Start_Date: document.getElementById("updatestart").value,
            // End_Date: document.getElementById("updateEnddate").value,
            Start_Date: isValidDate(startInputValue) ? startInputValue : null,
  End_Date: isValidDate(endInputValue) ? endInputValue : null,
