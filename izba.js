...
$("#updateButton").click(function () {
  ...
  fetch(`https://cleanstation.backendless.app/api/data/Fulfillment_Contract/${fcobjId}`)
    ...
    .then((data) => {
      ...
      var startDate = data.Start_Date || new Date();
      var formattedDate = startDate.toLocaleDateString('en-GB'); // Change 'en-GB' to your desired locale
      
      
      var endDate = data.End_Date || new Date();
      var formattedEndDate = endDate.toLocaleDateString('en-GB'); // Change 'en-GB' to your desired locale
     

      document.getElementById('updatestart').value = formattedDate;
      document.getElementById('updateEnddate').value = formattedEndDate
...
// Update Brand Name
        ...
        fetch(`https://cleanstation.backendless.app/api/data/Fulfillment_Contract/${fcobjId}`, {
          ...
          .then((updatedData) => {
            ...
            document.getElementById('startDateText').innerHTML = (data.Start_Date || new Date()).toLocaleDateString();
            document.getElementById('endDateText').innerHTML = (data.End_Date || new Date()).toLocaleDateString();
