      ...
      fetch(
        ...
        $("#FinalupdateButton").click(function () {
          ...
          const updatedData = {
            ...
            Start_Date: isValidDate(document.getElementById("updatestart").value) ? document.getElementById("updatestart").value : null,
            End_Date: isValidDate(document.getElementById("updateEnddate").value) ? document.getElementById("updateEnddate").value : null,
