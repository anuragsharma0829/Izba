...
$("#updateButton").click(function () {
  ...
  fetch(`https://cleanstation.backendless.app/api/data/Fulfillment_Contract/${fcobjId}`)
    ...
    .then((data) => {
      ...
      document.getElementById('updatestart').value = (data.Start_Date || new Date()).toLocaleDateString();
      document.getElementById('updateEnddate').value = (data.End_Date || new Date()).toLocaleDateString();
