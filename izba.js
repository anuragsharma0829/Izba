...
$(document).ready(function () {
  ...
  // calculation()
  debugger
  fetchDataAndCreateChart(EstimatPostid);
});
...
debugger
function fetchDataAndCreateChart(EstimateId) {
  ...
  // fetch(`https://cleanstation.backendless.app/api/data/Estimate/${id}`)
   fetch(`https://cleanstation.backendless.app/api/data/Estimate/${EstimatPostid}`)
    ...
    .then((data) => {
      ...
      // Create the doughnut chart using the fetched data
      new Chart(document.getElementById("doughnut-chart"), {
        type: "doughnut",
        data: {
          labels: ["Total Pick Fee", "Total Storage", "Total Receipts", "Misc Labor"],
    ...
    .catch((error) => {
      ...
      // Handle any errors that might occur during the API call or data retrieval
    });
}
