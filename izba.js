...
$("#updateButton").click(function () {
  ...
  fetch(
    ...
    .then((data) => {
      ...
      document.getElementById("updatestart").value = formattedEndDate;
      ...
      $("#FinalupdateButton").click(function () {
        ...
        const updatedData = {
          ...
          Storage_Per_Pallet: document.getElementById("updateStoragePerPallet")
            .value,
          Receipt_Per_Pallet_Fee: document.getElementById(
            "updaterecivingPerPallet"
          ).value,
          Receipt_Per_Case_Fee: document.getElementById("updateReceiptPerCase")
            .value,
        };
        ...
        fetch(
          ...
          .then((updatedData) => {
            ...
            document.getElementById("endDateText").innerHTML = (
