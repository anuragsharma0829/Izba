  ...
  $(document).ready(function () {
    ...
    $("#gotoEstimateDetail").click(function () {
      ...
      slider.on("input", function() {
        ...
        // Update all input elements with the slider value
        PalletsReceivedInput.val(sliderValue);
        casesReceived.val(sliderValue);
        palletStorage.val(sliderValue);
        shelfStorage.val(sliderValue);
        binStorage.val(sliderValue);
        baseOrders.val(sliderValue);
        basketSize.val(sliderValue);
        baseReturns.val(sliderValue);
        kitsCreated.val(sliderValue);
        warehouseHours.val(sliderValue);
        otHours.val(sliderValue);
        itHours.val(sliderValue);
      });
