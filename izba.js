...
$(document).ready(function () {
  ...
  $(document).ready(function () {
    ...
    $("#receiptPerPalletInput, #storagePerPalletInput, #storagePerShelfInput").on("input", function() {
      checkInputs();
    });
    ...
    function checkInputs() {
      ...
      var BaseOrdersValue = $("#BaseOrdersInput").val().trim();
      $("#BaseFeePerOrderInput").prop("readonly", BaseOrdersValue === "");

      var BasketSizeValue = $("#BasketSizeInput").val().trim();
      $("#AdditionalPickFeeInput").prop("readonly", BasketSizeValue === "");
      ...
      $("#ITHoursInput").prop("readonly", ITHourlyLaborValue === "");
