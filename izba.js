...
function calculation(newEstimation) {
  // Use the postId, fcobjId, and EstimatPostid variables here
  // const postId;
  // const fcobjId;
  // const EstimatPostid;
  ...
  function performCalculation() {
    ...
    // Estimator data
    fetch(`https://cleanstation.backendless.app/api/data/Estimate/${newEstimation}?loadRelations=Fulfillment_Contract`)
      .then((res) => res.json())
      .then((estimateData) => {
        console.log("Estimate data:", estimateData);
        TotalOrders = estimateData.TotalOrders;
