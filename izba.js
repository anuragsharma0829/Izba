...
const UpdateEstimatorqunt = {
 ...
 fetch(
  ...
  // Show Total Calculation in final table 
// Total Pick fee 
let baseOrderFeeandQunt = updatedData.Base_Per_Order_Fee*updatedEdata.TotalOrders;
let additionalOrderFeeandQunt=updatedData.Additional_Pick_Fee*updatedEdata.ExtraPicks;
let totalPickcalc = baseOrderFeeandQunt+additionalOrderFeeandQunt;
console.log("lo aa gaya",totalPickcalc);
});
