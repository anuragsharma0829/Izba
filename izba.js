  ...
  $(document).ready(function () {
    ...
    $("#gotoEstimateDetail").click(function () {
      ...
      $("#storagePerPalletInput").on("input", function() {
        var storagePerPalletValue = $(this).val().trim();
        if (storagePerPalletValue === "") {
          // If the storagePerPalletInput is empty, disable user input in PalletStorageInput
          $("#PalletStorageInput").prop("readonly", true);
        } else {
          // If the storagePerPalletInput has a value, enable user input in PalletStorageInput
          $("#PalletStorageInput").prop("readonly", false);
        }
      });
