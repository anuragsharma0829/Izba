  ...
  $("#updateButton").click(function () {
    ...
    fetch(
      ...
      .then((data) => {
        ...
        document.getElementById("updatestart").value = data.Start_Date || null;
        document.getElementById("updateEnddate").value = data.End_Date || null;
...
const UpdateEstimatorqunt={
        ...
        ReceiptPallet: document.getElementById("updatePalletRecived").value,
        ReceiptCase: document.getElementById("UpdateCasesReciive").value,
        Pallets: document.getElementById("updatePalletStorage").value,
        Shelfs: document.getElementById("UpdateShelfOccupied").value,
        Bins: document.getElementById("updateBinOccupied").value,
        TotalOrders:  document.getElementById("UpdateBaseOrder").value,
        ExtraPicks: document.getElementById("updateAdditionPic").value,
        Returns: document.getElementById("updateBasereturn").value,
        KitsBuilt: document.getElementById("updatePerKit").value,
        WHHours:  document.getElementById("updateStandardHours").value,
        OTHours: document.getElementById("updateOTHourConsumed").value,
        ITHours: document.getElementById("updateITHourConsumed").value
}
 ...
 fetch(
  ...
  .then((updatedEdata) => {
    ...
    // Pick Fee
    document.getElementById("totalBaseOrderText").innerHTML =
    updatedEdata.TotalOrders !== "" ? data.TotalOrders : "0";
  document.getElementById("totalAdditionalPickText").innerHTML =
  updatedEdata.ExtraPicks !== "" ? data.ExtraPicks : "0";
  document.getElementById("totalBaseReturnText").innerHTML =
  updatedEdata.Returns !== "" ? data.Returns : "0";
  document.getElementById("totalKitText").innerHTML =
  updatedEdata.KitsBuilt !== "" ? data.KitsBuilt : "0";

  // Storage
  document.getElementById("totalPalletStorageText").innerHTML =
  updatedEdata.Pallets !== "" ? data.Pallets : "0";
  document.getElementById("totalShelfStorageText").innerHTML =
  updatedEdata.Shelfs !== "" ? data.Shelfs : "0";
  document.getElementById("totalBinStorageText").innerHTML =
  updatedEdata.Bins !== "" ? data.Bins : "0";

  // Receiving
  document.getElementById("totalPalletReceivedText").innerHTML =
  updatedEdata.RceiptPallet !== "" ? data.RceiptPallet : "0";
  document.getElementById("totalcasesReceivedText").innerHTML =
  updatedEdata.ReceiptCase !== "" ? data.ReceiptCase : "0";

  // Labour
  document.getElementById("totalStandardHourtext").innerHTML =
  updatedEdata.WHHours !== "" ? data.WHHours + " Hours" : "0 Hours";
  document.getElementById("totalOTHourlyText").innerHTML =
  updatedEdata.OTHours !== "" ? data.OTHours + " Hours" : "0 Hours";
  document.getElementById("totalITHourlyText").innerHTML =
  updatedEdata.ITHours !== "" ? data.ITHours + " Hours" : "0 Hours";
  })
  .catch((error) => console.error("Error:", error));
...
// Show Calculation in final Table 
