...
function calculateUpdateDays() {
  ...
  //
      ...
      checkStoragePerPalletInput();

      // Attach the input event handler to storagePerPalletInput
      $("#storagePerPalletInput").on("input", function() {
        checkStoragePerPalletInput();
      });
  
      function checkStoragePerPalletInput() {
        var storagePerPalletValue = $("#storagePerPalletInput").val().trim();
        $("#PalletStorageInput").prop("disabled", storagePerPalletValue === "");
      }
