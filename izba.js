...
$(document).ready(function () {
  ...
  $("#goToStorage").click(function () {
    ...
    if (receiptPerCase !== "" || receiptPerPallet !== "") {
      ...
      const errorReciving = document.getElementById('Please fill any one of in this fields');
...
$(document).ready(function () {
  ...
  $("#goToPicking").click(function () {
    ...
    if (
      ...
      const errorStorage = document.getElementById('Please fill any one of in this fields');
...
$(document).ready(function () {
  ...
  $("#goToMisc").click(function () {
    ...
    if (
      ...
      const errorPicking = document.getElementById('Please fill any one of in this fields');
...
$(document).ready(function () {
  ...
  $("#goToEstimates").click(function () {
    ...
    if (
      ...
      const errorMisc = document.getElementById('Please fill any one of in this fields');
