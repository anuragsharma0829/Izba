    ...
    fetch(`https://cleanstation.backendless.app/api/data/Fulfillment_Contract/${id}`).then(
      (res) => {
        res.json().then((data) => {
          console.log(data);
          console.log(data.brand_name);
          document.getElementById('endDateText').innerHTML=data.Start_Date.toLocaleDateString();
          document.getElementById('startDateText').innerHTML=data.End_Date.toLocaleDateString();
...
$("#updateButton").click(function () {
  ...
  handleFcobjId(fcobjId); // Call handlePostId function with the postId valu
  ...
  fetch(`https://cleanstation.backendless.app/api/data/Fulfillment_Contract/${fcobjId}`).then(
    ...
    document.getElementById('updatestart').innerHTML = data.Start_Date.toLocaleDateString();
    document.getElementById('updateEnddate').innerHTML = data.End_Date.toLocaleDateString();
    document.getElementById('updateManagementFee').innerHTML=data.Management_Fee
    document.getElementById('updateMInimumFee').innerHTML=data.Minimum_Fee
    document.getElementById('updateWarehouseFee').innerHTML=data.Labor_Warehouse_Rate
    document.getElementById('updateOTLabor').innerHTML=data.Labor_OT_Rate
    document.getElementById('updateITLabor').innerHTML=data.Labor_IT_Rate
    document.getElementById('updateBaseorderfee').innerHTML=data.Base_Per_Order_Fee
    document.getElementById('updateAdditinpickfee').innerHTML=data.Additional_Pick_Fee
    document.getElementById('updateBasereturnFee').innerHTML=data.Base_Per_Return_Fee
    document.getElementById('updatePerkitfee').innerHTML=data.Additional_Pick_Kit
    document.getElementById('updateperBin').innerHTML=data.Storage_Per_Bin
    document.getElementById('updatePerSelf').innerHTML=data.Storage_Per_Shelf
    document.getElementById('updateStoragePerPallet').innerHTML=data.Storage_Per_Pallet
    document.getElementById('updaterecivingPerPallet').innerHTML=data.Receipt_Per_Pallet_Fee
    document.getElementById('updateReceiptPerCase').innerHTML=data.Receipt_Per_Case_Fee
          //show in update form
