...
$(document).ready(function () {
  ...
  fetch(
    ...
    .then((res) => res.json())
    .then((data) => {
      console.log("estimator data for calculation", data);
      Base_Per_Order_Fee = data.Base_Per_Order_Fee;
      Additional_Pick_Fee = data.Additional_Pick_Fee;
      Base_Per_Return_Fee = data.Base_Per_Return_Fee;
      Additional_Pick_Kit = data.Additional_Pick_Kit;

      // Check if TotalOrders is present in the data
      if (data.hasOwnProperty("TotalOrders")) {
        totalBaseOrder = data.TotalOrders;

        // Now that we have the data, proceed with the calculations
        TotalPickCharges =
          Base_Per_Order_Fee * totalBaseOrder +
          Additional_Pick_Fee * totalAdditionalPick +
          Base_Per_Return_Fee * totalBaseReturn +
          Additional_Pick_Kit * totalKit;
        ...
        console.error("TotalOrders not found in the data");
      }
    })
    .catch((error) => {
