...
document.getElementById("wf-login-btn").addEventListener("click", function () {
  $("#registrationSectionId").hide();
  var uemil = document.getElementById("wf-log-in-email").value;
  var Password = document.getElementById("wf-log-in-password").value;
