     ...
     async function saveEstimateData() {
      try {
        ...
        if (response.ok) {
          ...
          // Check for the correct property name of EstimateId in the API response
          const EstimateId = responseData.EstimateId || responseData.objectId;
          console.log("EstimateId:", EstimateId);

          // Store EstimateId in localStorage
