  ...
  $(document).ready(function () {
    $("#gotoEstimateDetail").click(function () {
      ...
      let estimatorDetails = {
        Base_Per_Order_Fee: parseFloat(BaseFeePerOrderInput) ?? 0,
        ReceiptCase: parseFloat(palletsReceived)?? 0,
      ...
      // Call API
      fetch(
        "https://cleanstation.backendless.app/api/data/Estimate",
        {
          method: "POST",
  ...
  console.log("Retrieved Estimator:", id);
   ...
   // Handle relation
      ...
      // load estimator by id 
        ...
        fetch(`https://cleanstation.backendless.app/api/data/Estimate/${id}?loadRelations=Fulfillment_Contract`).then(
        (res) => {
          res.json().then((data) => {
            ...
            // Reciving 
            document.getElementById('totalPalletReceivedText').innerHTML=data.RceiptPallet;
            document.getElementById('totalcasesReceivedText').innerHTML=data.ReceiptCase;

            // Labour
            document.getElementById('totalStandardHourtext').innerHTML=data.WHHours + "Hours";
            document.getElementById('totalOTHourlyText').innerHTML=data.OTHours + "Hours";
            document.getElementById('totalITHourlyText').innerHTML=data.ITHours + "Hours";
