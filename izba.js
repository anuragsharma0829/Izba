...
// ).then((res) => {
//  res.json().then((data) => {
//    console.log("fc data for calculation",data);
...
// // get estiator data contact data 
// // let Base_Per_Order_Fee,Additional_Pick_Fee,Base_Per_Return_Fee,Additional_Pick_Kit;
...
fetch(`https://cleanstation.backendless.app/api/data/Fulfillment_Contract/${fcobjId}`)
  .then((res) => {
    res.json().then((data) => {
      ...
      // Perform calculations or other operations using these variables
    });
  });

// get estimator contact data
fetch(`https://cleanstation.backendless.app/api/data/Estimate/${id}`)
  .then((res) => {
    res.json().then((data) => {
      TotalOrders = data.TotalOrders;
      ExtraPicks = data.ExtraPicks;
...
console.log("<<<<<<>>>>>",TotalOrders);
 console.log("<<<<<<>>>>>",Additional_Pick_Fee);
 console.log("<<<<<<>>>>>",ExtraPicks);
  let TotalpicCharges;
  TotalpicCharges= Base_Per_Order_Fee*TotalOrders+Additional_Pick_Fee*ExtraPicks+Base_Per_Return_Fee*Returns+Additional_Pick_Kit+KitsBuilt;

  let totalsEstimte = {
    TotalPickCharge: TotalpicCharges,
  };
