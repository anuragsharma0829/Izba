  ...
  $("#goToReciving").click(function () {
    ...
    if (brandNameInput !== "") {
      ...
      Swal.fire({
        position: 'top-end',
        icon: 'error',
        title: 'Brand Name Should not be empty',
...
let data2 = document.getElementById('data').length;
if (data2 >=1 ) {
    document.getElementById("fcConatainer").style.display="none";
}
    ...
    $("#SignUpButton").click(function () {
      ...
      fetch("https://cleanstation.backendless.app/api/data/Users", {
        ...
        .then((data) => {
          ...
          alert("User Registration Success"); // Alert only on successful registration
          $("#loginSection").show();
        ...
        .catch((error) => {
          ...
          alert("Something went wrong"); // Show an alert for errors
        });
    });
  });
