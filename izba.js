...
$(document).ready(function () {
  ...
  //         // Log the fulfillment contract data
  //         console.log("Fulfillment Contract data:");
  ...
  //             let TotalPickCharges = Base_Per_Order_Fee * TotalOrders + Additional_Pick_Fee * ExtraPicks + Base_Per_Return_Fee * Returns + Additional_Pick_Kit + KitsBuilt;
        ...
        .then((data) => {
          ...
          fetch(`https://cleanstation.backendless.app/api/data/Fulfillment_Contract/${fcobjId}`)
            ...
            .then((data) => {
              ...
              // Storage
              Storage_Per_Pallet=data.storagePerPallet;
              Storage_Per_Shelf=data.storagePerShelf;
              Storage_Per_Bin=data.storagePerBin;
              // labour
              ...
              // Log the fulfillment contract data
              console.log("Fulfillment Contract data:");
              console.log("Receipt_Per_Pallet_Fee:", Receipt_Per_Pallet_Fee);
              console.log("Receipt_Per_Case_Fee:", Receipt_Per_Case_Fee);
              // console.log("Base_Per_Return_Fee:", Base_Per_Return_Fee);
              // console.log("Additional_Pick_Kit:", Additional_Pick_Kit);
              ...
              fetch(`https://cleanstation.backendless.app/api/data/Estimate/${EstimateId}`)
                ...
                .then((data) => {
                  ...
                  let totalExtPic = Additional_Pick_Fee * ExtraPick;
                  ...
                  // Total storage
                   let TotalStorage = (Storage_Per_Pallet*Pallets+Storage_Per_Shelf*Shelfs+Storage_Per_Bin*Bins) * 12;
                  //  labour
                  ...
                  fetch(`https://cleanstation.backendless.app/api/data/Estimate/${EstimateId}`, {
                    ...
                    .then((getTotals) => {
                      console.log("All totals????????", getTotals);
                      document.getElementById('TotalPickFeesCalc').textContent = "$" + getTotals.TotalPickCharge;
                      document.getElementById('TotalStorage').textContent = "$" + getTotals.TotalReceiptCharge;
                      document.getElementById('TotalkReceipt').textContent = "$" + getTotals.TotalStorageCharge;
