    ...
    $("#SignIpButton").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#formBlock").text("Login Successful").css({ display: "block", color: "white", backgroundColor: "green" });
                $("#loginSection").hide();
                $("#loginBtn").hide();
                $("#UserNameBlock").show();
            ...
            error: function (error) {
                ...
                $("#formBlock").text("Error: Login failed. Please check your credentials and try again.").css({ display: "block", color: "white", backgroundColor: "red" });
            },
        });
    });
});
