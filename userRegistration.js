    ...
    $("#SignIpButton").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // Note: The `data` object should only contain necessary user information, not sensitive data like password
                document.cookie = `userData=${JSON.stringify(data)}; path=/`;

                // Set the success message for the login
                $("#headerBlock").removeClass("red").addClass("green").text("Login Successful").show();
            ...
            error: function (error) {
                ...
                $("#headerBlock").removeClass("green").addClass("red").text("Error: Login failed. Please check your credentials and try again.").show();
