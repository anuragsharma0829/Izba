    ...
    $("#SignInButton").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // Assuming you have the objectId in the response data
                const objectId = data.objectId;

                // Make the second API call to check the status using the objectId
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response === true) {
                            // If the response is true, show the Brand Hero Section
                            $("#CreateBrandSection").hide();
                            $("#BrandHeroSection").show();
                        } else {
                            // If the response is false, show the Create Brand Section
