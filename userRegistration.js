...
$(document).ready(function () {
    ...
    $("#SignIpButton").click(function () {
        ...
        $.ajax({
            url: "https://api.backendless.com/4921FD25-45AC-9E96-FF7F-865537F72100/6B4F94DC-59DA-42A3-AC9D-C7974DD0B601/users/login", // Replace with your API endpoint for login
            type: "POST",
