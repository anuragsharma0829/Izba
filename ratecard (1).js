...
async function showAuditforinvoice(objectId) {
    ...
    const auditItemsPerPage = 5; // You can change the number of items per page here
...
const invoiceItemsPerPage = 5; // You can change the number of items per page here
