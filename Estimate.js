    ...
    fetch(`https://cleanstation.backendless.app/api/services/Estimate/EstimateIDToData?ID=${objectId}`).then(
        (res) => {
            res.json().then((data) => {
                ...
                document.getElementById("updateCountyList").value = data.Contract_name || "Izba1";
                document.getElementById("updateRateCardList").value = EstimateRCName || "test";
                document.getElementById("updateServiceList").value = EstimateServiceName || "test";
                ...
                document.getElementById("ESTOThoursinput").value = data.OTHours || 0;
                document.getElementById("ESTIThours").value = data.ITHours || 0;
