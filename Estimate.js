...
async function getEstimateData(objctId){
    ...
    fetch(`https://cleanstation.backendless.app/api/services/Estimate/EstimateIDToData${objctId}`).then(
        (res) => {
          res.json().then((data) => {
            document.getElementById("EstimateContractName").innerHTML = data.Estimate_Name;

            document.getElementById("EstimateFCName").innerHTML = data.Estimate_Name;
            document.getElementById("EstimateRCName").innerHTML = data.Estimate_Name;
            document.getElementById("EstimateServiceName").innerHTML = data.Estimate_Name;
            ...
            document.getElementById("ESTtotalPalletReceivedText").innerHTML = data.ReceiptPallet;
            document.getElementById("ESTtotalcasesReceivedText").innerHTML = data.ReceiptCase;


            document.getElementById("ESTtotalPalletStorageText").innerHTML = data.Pallets;
            document.getElementById("ESTtotalShelfStorageText").innerHTML = data.Shelfs;
            document.getElementById("ESTtotalBinStorageText").innerHTML = data.Bins;
           
            document.getElementById("ESTtotalBaseOrderText").innerHTML = data.TotalOrders;
            document.getElementById("ESTtotalAdditionalPickText").innerHTML = data.ExtraPicks;
            document.getElementById("ESTtotalBaseReturnText").innerHTML = data.Returns;
            document.getElementById("ESTtotalKitText").innerHTML = data.KitCost;
             
            document.getElementById("ESTtotalStandardHourtext").innerHTML = data.WHHours;
            document.getElementById("ESTtotalOTHourlyText").innerHTML = data.OTHours;
            document.getElementById("ESTtotalITHourlyText").innerHTML = data.ITHours;
  
            document.getElementById("ESTTotalPickFeesCalc").innerHTML = data.TotalPickCharge;
            document.getElementById("ESTTotalStorage").innerHTML = data.TotalStorageCharge;
            document.getElementById("ESTTotalkReceipt").innerHTML = data.TotalReceiptCharge;
            document.getElementById("ESTTotalMisclabor").innerHTML = data.TotalMiscCharge;
            document.getElementById("ESTtotal3plshipping").innerHTML = data.Total3PLShipping;
            document.getElementById("ESTtotalbrnadshipping").innerHTML = data.TotalBrandShipping;
...
function handleEstimateID(objId){
    ...
    let ratecardName = localStorage.getItem("selectedRateCardName");
      ...
      // BrandName
      fetch(`https://cleanstation.backendless.app/api/services/Estimate/EstimateIDToData?ID=${objId}`).then(
        (res) => {
          res.json().then((data) => {
    ...
    //     console.log("eeee",data);
            ...
            // Pick fee
            // document.getElementById("ESTbaseOrderFeeText").textContent = data.TotalOrders;
            // document.getElementById("ESTtotalBaseOrderText").textContent = contractName;
            // document.getElementById("ESTadditionalPickFeeText").textContent = ratecardName;
            // document.getElementById("ESTtotalAdditionalPickText").textContent = serviceName;
            // document.getElementById("ESTbaseReturnFeeText").textContent = data.Start_Date;
            // document.getElementById("ESTtotalBaseReturnText").textContent = data.End_Date;
            // document.getElementById("ESTperKitFeeText").textContent = data.End_Date;
            // document.getElementById("ESTtotalKitText").textContent = data.End_Date;
