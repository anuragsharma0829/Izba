...
$("#ESTcreateunitbutton").click(function () {
    ...
    fetch(
        ...
        .then((data) => {
            ...
            renderestimateTable(EstimateId);
...
async function setDataForUpdate(objectId) {
    ...
    .then((res) => {
            res.json().then((data) => {
                ...
                document.getElementById("updateCountyList").innerHTML = localStorage.getItem("selectedContractId");
                document.getElementById("updateRateCardList").innerHTML =localStorage.getItem("selectedRateCardId");
                document.getElementById("updateServiceList").innerHTML = localStorage.getItem("selectedServiceId");

                // $("#updateEstimateStartDate").val(formatDate(data.Start_Date));
                // $("#updateEstimateEndDate").val(formatDate(data.End_Date));
                document.getElementById("updateEstimateStartDate").innerHTML = formatDate(data.Start_Date);
                document.getElementById("updateEstimateEndDate").innerHTML = formatDate(data.End_Date)
                ...
                document.getElementById("UESTOThoursinput").innerHTML = data.OTHours || 0;
                document.getElementById("UESTIThours").innerHTML = data.ITHours || 0;
