    ...
    fetch(`https://cleanstation.backendless.app/api/services/Estimate/EstimateIDToData?ID=${objctId}`).then(
        (res) => {
          res.json().then((data) => {
            ...
            document.getElementById("EstimateFCName").innerHTML = data.Contract_name;
            ...
            const startDateText = `${startDat.getDate()}/${startDat.getMonth() + 1}/${startDatee.getFullYear()}`;
...
const timeDifference = endDat.getTime() - startDat.getTime();
const daysDifference = timeDifference / (1000 * 3600 * 24);
document.getElementById("EstimateFCtotalDaysText").textContent = daysDifference;
            ...
            document.getElementById("ESTtotalBaseOrderText").innerHTML = data.Base_Per_Order_Fee|| 0;
            document.getElementById("ESTtotalAdditionalPickText").innerHTML = data.Additional_Pick_Fee|| 0;
            document.getElementById("ESTtotalBaseReturnText").innerHTML = data.Returns|| 0;
            document.getElementById("ESTtotalKitText").innerHTML = data.KitCost|| 0;
