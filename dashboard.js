...
$(document).ready(function () {
    ...
    $("#CreateContractRateButton").click(function () {
        ...
        let Contract_name = $("#ContractNameText").val().trim();
        let Start_Date = $("#startDateText").val().trim();
        let End_Date = $("#endDateText").val().trim();
        let centeName = $("#fcNameText").val().trim();
        // pick and pack
        ...
        fetch(
            ...
            .then((response) => response.json())
            .then((data) => {
                console.log("Paras API done toatal", data);
                // Continue with the logic or update the UI as needed
