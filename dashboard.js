...
$("#CreateBrandButton").click(function () {
  ...
  if (BrandName !== "" && BrandURl !== "" && ShoppingCartDropDown !== "") {
    ...
    BrandMessage.innerHTML = "Please fill out all the required fields. ";
  ...
  $("#CreateServiceButton")
    ...
    .on("click", function () {
      ...
      if (serviceName !== "") {
        ...
        // $("#serviceName").val("");
        const serviceaddError = document.getElementById(
...
function addRow(name, item) {
  ...
  collapseButton.textContent = "▼"; // You can use any suitable icon here
    ...
    item.Zone_Cards.forEach(function (zoneCard) {
      ...
      tableRow.innerHTML = `
        <td  style="background-color: green; color: white; height: 30px; text-align: center;">
          ${zoneCard["Weight_" + item.Weight_Unit]} ${item.Weight_Unit}
        </td>
        <td style ="padding: 2px 5px; text-align: center;">
          <input type="text" class="demoService" data-object-id="${item.objectId}" data-zone-number="1" value="${zoneCard.Zone_1}" zone-object-id="${zoneCard.objectId}" />
        </td>
        <td style ="padding: 2px 5px; text-align: center;">
          <input type="text" class="demoService" data-object-id="${item.objectId}" data-zone-number="2" value="${zoneCard.Zone_2}" zone-object-id="${zoneCard.objectId}"  />
        </td>
        <td style ="padding: 2px 5px; text-align: center;">
          <input type="text" class="demoService" data-object-id="${item.objectId}" data-zone-number="3" value="${zoneCard.Zone_3}" zone-object-id="${zoneCard.objectId}"  />
        </td>
        <td style ="padding: 2px 5px; text-align: center;">
          <input type="text" class="demoService" data-object-id="${item.objectId}" data-zone-number="4" value="${zoneCard.Zone_4}" zone-object-id="${zoneCard.objectId}"  />
        </td>
        <td style ="padding: 2px 5px; text-align: center;">
          <input type="text" class="demoService" data-object-id="${item.objectId}" data-zone-number="5" value="${zoneCard.Zone_5}" zone-object-id="${zoneCard.objectId}"  />
        </td>
        <td style ="padding: 2px 5px; text-align: center;">
          <input type="text" class="demoService" data-object-id="${item.objectId}" data-zone-number="6" value="${zoneCard.Zone_6}" zone-object-id="${zoneCard.objectId}"  />
        </td>
        <td style ="padding: 2px 5px; text-align: center;">
          <input type="text" class="demoService" data-object-id="${item.objectId}" data-zone-number="7" value="${zoneCard.Zone_7}" zone-object-id="${zoneCard.objectId}" />
        </td>
        <td style ="padding: 2px 5px; text-align: center;">
          <input type="text" class="demoService" data-object-id="${item.objectId}" data-zone-number="8" value="${zoneCard.Zone_8}" zone-object-id="${zoneCard.objectId}"  />
        </td>
      `;
