...
function handleRateEdit(objectId) {
  ...
  fetch(
    ...
    .then((data) => {
      ...
      const brandContractValue = document.getElementById("updatetoggleSwitch").value = data.Brand_Contract;
      if (brandContractValue === true) {
        document.getElementById("updatetoggleSwitch").value = data.Brand_Contract;
      }
      ...
      $("#updaterateCard").click(function () {
        ...
        const updatedData = {
          ...
          Brand_Contract: updatetoggleValue,
        };
...
$("#addFCenter").click(function () {
  ...
  $("#CreateFulfillmentCenterForm").show();
  $("#CreateFulfillmentContractSection").hide();
});
...
document.getElementById("addFccenterBTN").addEventListener("click", function () {
  ...
  var fcCounter = document.getElementById("fcCounter").value;
  ...
  var data = {
      fcName: fcName,
      fcUrl: fcUrl,
      storageTypeDropdown: storageTypeDropdown,
      fcaddress: fcaddress,
      fcCity: fcCity,
      fcZipCode: fcZipCode,
      fcCounter: fcCounter
