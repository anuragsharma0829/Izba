...
function handleRateEdit(objectId) {
 console.log("check one objectId", objectId);
  $("#ratecardDetailSection").hide();
  $("#FulfillmentContractDetailSection").hide();
  $("#UpdateRateCard").show();
  $("#RCUpdate").show();
  ...
  console.log("check two ratecardID",ratecardID);
  ...
  fetch(
    ...
    .then((data) => {
      ...
      // document.getElementById("updateCarrierType").innerHTML = data.Carrier_Type;
