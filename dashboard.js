...
//                 }</td>
//                 <td style="padding: 8px; border-bottom: 1px solid #ccc;">
//                   <a class="contract-name" data-contract-id="${
//                     contract.objectId
//                   }">
...
//                     <a class="rate-card-link" href="#" onclick="handleRateCardClick('${
//                       item.objectId
...
//                           item.objectId
//                         }')"></span>
//                         <span class="delete-btn glyphicon glyphicon-trash" onclick="handleRateDelete('${
//                           item.objectId
//                         }')"></span>
//                     </td>
//                 </tr>
...
//       paginationHtml += `<li${
//         rateCurrentPage === i ? ' class="active"' : ""
...
//         tableRow.innerHTML = `
//             <td  style="background-color: green; color: white; height: 30px;">${
//               zoneCard["Weight_" + item.Weight_Unit]
//             } ${item.Weight_Unit}</td>
            
            
//       <td><input type="text" class="demo" data-object-id="${
//         item.objectId
...
// function for get partcular contract data 

async function showContractDetailbyId(contractId){
    let contractDetails = {
    objectId: contractId,
  };
...
// Edit fullfilmentContract using ID

async function updateContractData(objectId){
...
// Delete Contract Using ID
async function deleteContract(objectId){
    Swal.fire({
    icon: "info",
    title: "Are You sure",
    confirmButtonText: "Delete",
...
// show contract for currentt users

        // Global variables
        let contractCurrentPage = 1;
        const contractItemsPerPage = 1; // You can change the number of items per page here
        let currentContractId = null;
        // Function to fetch data from API
...
function changeRatePage(pageNumber) {
    ...
    renderContractTable(contractCurrentPage);
        ...
        function handleContractEdit(objectId) {
            updateContractData(objectId)
        }

        // Function to handle Delete button click
        function handleContractDelete(objectId) {
           deleteContract(objectId)
        }


// Function to handle Delete button click
function handleContractData(objectId) {
    // show particular data of contract using objectId 
         showContractDetailbyId(objectId)
