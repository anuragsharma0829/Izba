...
$(document).ready(function () {
    $("#CreateContractRatesBtn").click(function () {
        ...
        if (cName.trim() === "") {
            // Show error message for contract name
            ...
            return; // Stop execution here if there is an error
        } else if (centers.trim() === "" || startDate.trim() === "" || endDate.trim() === "") {
            ...
            fetch(
                ...
                .then((data) => {
                    ...
                    // Show the fulfillmentContractSection after API call success
                    $("#fulfillmentContractSection").show();
