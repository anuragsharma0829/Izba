...
function reloadTestDriveSection() {
    var $section = $("#testdrive");
    var currentContent = $section.html();

    // Detach the section and reattach it to refresh the content
    $section.detach().appendTo($section.parent());

    // Set the original content back
    $section.html(currentContent);
}
