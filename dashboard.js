...
async function productsAlldata(objID){
    ...
    async function fetchpData(offset, size) {
        const url = `https://cleanstation.backendless.app/api/services/Product/productIdToData?ID=${objID}&Offset=0&Size=${size}`;
    ...
    async function renderproductTable(page) {
        ...
        currentPage = page;
        const data = await fetchpData(offset, pageSize);
        ...
        renderPaginationproduct(totalDataCount, pageSize, currentPage);
    }

    // Function to render pagination links
    function renderPaginationproduct(totalItems, pageSize, currentPage) {
    ...
    function changePageSize() {
        renderproductTable(1); // Reset to the first page when the page size changes
    }
