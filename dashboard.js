  ...
  function editContract(contractId) {
    ...
    fetch(apiUrl, {
      ...
      .then((data) => {
        ...
        $("#upstartDate").val(formattedStartDate);
        $("#upendDate").val(formattedEndDate);

        const timeDifference = formattedStartDate.getTime() - formattedEndDate.getTime();
        // Convert the time difference to days
        const daysDifference = timeDifference / (1000 * 3600 * 24);
        document.getElementById("uptotal-Days").innerHTML = daysDifference;
