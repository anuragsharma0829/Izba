        ...
        if (result.isConfirmed) {
            ...
            fetch(
                ...
                .then((data) => {
                    ...
                    var currentContent = $("#testdrive").html();

                    // Set the content of the #testdrive section to the same content
                    $("#testdrive").html(currentContent);
                })
        ...
        if (ratecarName !== "") {
            ...
            fetch(
                ...
                .then((data) => {
                    ...
                    var updatedSectionContent = $(response).find("#testdrive").html();

                    // Replace the content of the #testdrive section
                    $("#testdrive").html(updatedSectionContent);
