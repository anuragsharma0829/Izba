    ...
    .then((data) => {
     ...
     rateCradNameforupdate = data.Rate_Card_Name;
      updateCarrierType = data.Carrier_Type;
       ...
       console.log("variables value===",rateCradNameforupdate, updateCarrierType, updatetoggleSwitch);

      $("#updaterateCard").click(function () {
        // Update rateCradNameforupdate with the latest user input
        rateCradNameforupdate1 = $("#updateRateCard").val();
        updateCarrierType1 = $("#updateCarrierType").val();
        updatetoggleSwitch1 = $("#updatetoggleSwitch").val(); 
