...
function handleRateEdit(objectId) {
  ...
  fetch(
    ...
    .then((data) => {
      ...
      let brandContractValue = document.getElementById('updatetoggleSwitch').innerHTML = data.Brand_Contract;
      if (brandContractValue === true) {
        var updatetoggleValue = localStorage.getItem("updatetoggleValue");
      }
      ...
      fetch(
        ...
        .then((data) => {
          ...
          document.getElementById("CarrierTypeText").innerHTML =
            data.Carrier_Type;
          document.getElementById("BrandContractText").innerHTML =
            localStorage.getItem("toggleValue");
        })
        .catch((error) => console.error("Error:", error));
    } else {
