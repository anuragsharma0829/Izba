 ...
 let ratecardID = {
  ...
  fetch(
    ...
    .then((data) => {
      ...
      //   };
      //   console.log("updated variables value===",rateCradNameforupdate1, updateCarrierType1, updatetoggleSwitchValue1);
