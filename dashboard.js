...
function handleRateEdit(objectId) {
    const redirectUrl = "https://izba-exchange.webflow.io/rate-card?object_id=" + objectId;
...
function handleRateCardClick(objectId) {
    // Handle the click event for the rate card name here
    console.log("Rate Card clicked with objectId:", objectId);
    // You can do further actions here, like fetching more details of the rate card using the `objectId`.
}
