        ...
        if (result.isConfirmed) {
            ...
            fetch(
                ...
                .then((data) => {
                    ...
                    $("#FulfillmentContractDetailSection").load(location.href + " #FulfillmentContractDetailSection", function() {
        ...
        if (ratecarName !== "") {
            ...
            fetch(
                ...
                .then((data) => {
                    ...
                    $("#FulfillmentContractDetailSection").load(location.href + " #FulfillmentContractDetailSection");
