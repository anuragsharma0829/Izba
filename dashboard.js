...
//     $.ajax({
//       url: `https://cleanstation.backendless.app/api/services/Brand/CheakBrand?userId=${userObjID}`,
//       type: "GET",
//       contentType: "application/json; charset=UTF-8",
//       dataType: "json",
//       success: function (response) {
...
//   objectId: userObjID,
// };
//   fetch(`https://cleanstation.backendless.app/api/services/Brand/UserIDToBrand?UserID=${data.objectId}`, {
//     method: "GET",
...
function hndlFcId(id) {
  ...
  fetch(
    ...
    .then((data) => {
      ...
      document.getElementById("fcNameTextt").innerHTML = data.Fulfillment_Center.Center_Name.State.Country.ZIP_Code;
