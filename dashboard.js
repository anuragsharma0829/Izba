  ...
  fetch(
    ...
    .then((data) => {
      ...
      if (data.Brand_Contract) {
        ...
        // document.getElementById("updatetoggleSwitch").value = true;
      }else{
        document.getElementById("updatetoggleSwitch").checked = false;
        // document.getElementById("updatetoggleSwitch").value = false;
      }

      // Set the initial value of rateCradNameforupdate from the API response
      rateCradNameforupdate = data.Rate_Card_Name;
      updateCarrierType = data.Carrier_Type;
      updatetoggleSwitch = data.Brand_Contract;
...
// Define the renderRateTable function
function renderRateTable(rateCurrentPage)
 {
  rateCurrentPage.append(newRow);
}
// ADD RATE CARD
$(document).ready(function () {
