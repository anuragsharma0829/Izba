...
let carrierTypeUpdate;
let brandContractUpdate;
function handleRateEdit(objectId) {
  ...
  fetch(
    ...
    .then((data) => {
      ...
      carrierTypeUpdate = data.Carrier_Type;
      brandContractUpdate = data.Brand_Contract;
      ...
      $("#updaterateCard").click(function () {
        ...
        carrierTypeUpdate = $("#updateShippingDropdown").val();
        brandContractUpdate = $("#updatetoggleSwitch").val();
...
$(document).ready(function () {
  $("#addRCcardbtn").click(function () {
    ...
    let CarrierTypeValue = "USPS";
    let Carrier_Type = localStorage.getItem("RCtype"); 
    let BrandContractValue = "False";
    let Brand_Contract = localStorage.getItem("toggleValue"); 
    ...
    if (ratecarName !== "") {
      ...
      let ratecardDetail = {
        ...
        Carrier_Type: Carrier_Type || CarrierTypeValue,
        Brand_Contract: Brand_Contract || BrandContractValue,
      };
      fetch(
