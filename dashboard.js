...
$("#mainSection").click(function () {
    $("#Detail, #Create, #Update, #RCDetail, #RCCreate, #RCUpdate").hide();
...
// async function sendProductData(requestData, retries = 0, delay = 2000) {
//     $("#loader").show(); // Show the loader
//     try {
//         const response = await fetch('https://cleanstation.backendless.app/api/services/Product/Upload_product', {
//             method: 'POST',
...
//     } catch (error) {
//         console.error('Error sending data:', error);
//         Swal.fire("Error", "Somthing is went wrong !!", "error");
//             document.getElementById("ProductFIleNameInput").value = "";
//             document.getElementById("fileInput2").value = "";
//         if (retries > 0) {
//             // Retry with exponential backoff
