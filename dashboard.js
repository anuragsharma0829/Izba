...
let BrandID = {
  ...
  fetch("https://cleanstation.backendless.app/api/services/Brand/UserIDToBrand", {
    ...
    .then((data) => {
      ...
      UserBrandID = data.objectId;
      console.log(UserBrandID);
      document.getElementById("Brand-URl-Text").innerHTML = UserBrandID.URL;
      document.getElementById("BrandNameText").innerHTML = UserBrandID.brand_name;
    })
...
function hndlFcId(id) {
  ...
  fetch(
    ...
    .then((data) => {
      ...
      document.getElementById("fcNameTextt").innerHTML = data.Fulfillment_Center.Center_Name , data.Fulfillment_Center.State , data.Fulfillment_Center.Country , data.Fulfillment_Center.ZIP_Code;
