    ...
    .then((data) => {
      ...
      $("#UpdateContractRateButton").click(function () {
        ...
        const requestBody = {
          ...
          Center_name: localStorage.getItem("selectedEditCenterName") || Center_name,
  ...
  fetch(
    ...
    .then((data) => {
      ...
      $("#updaterateCard").click(function () {
        ...
        Carrier_Type = $("#updateShippingDropdown").val();
        const updatedData = {
          Rate_Card_ID: {
            objectId: objectId,
          },
          Rate_Card_Name: rateCradNameforupdate,
          Carrier_Type: localStorage.getItem("updateRctype") || Carrier_Type,
          Brand_Contract: updatetoggleValue || Brand_Contract,
        };
        ...
        fetch(
          ...
          .catch((error) => console.error("Error to update data:", error));
      });
    });
}
  ...
  $("#addRCcardbtn").click(function () {
    ...
    if (ratecarName !== "" || shippingDropdown !== "" || toggleSwitch !== "") {
      ...
      let ratecardDetail = {
        ...
        Carrier_Type: shippingDropdown || localStorage.getItem("RCtype"),
        Brand_Contract: localStorage.getItem("toggleValue") || true,
      };
      fetch(
