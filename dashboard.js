...
$("#Baseorderfee").val(extractNumericValue(parsedValues['Base_Per_Order_Fee']?.value?.replace(/\$|,/g, ''))|| 0);
// $("#additionalPickfee").val(extractNumericValue(extractedValue));
$("#additionalPickfee").val(extractNumericValue(parsedValues['Additional_Pick_Fee']?.value?.replace(/\$|,/g, ''))|| 0);
$("#BaseReturnFee").val(extractNumericValue(parsedValues['Base_Per_Return_Fee']?.value?.replace(/\$|,/g, '').replace('Hourly', ''))|| 0);

$("#PerKitFee").val(extractNumericValue(parsedValues['Additional_Pick_Kit']?.value?.replace(/\$|,/g, '').replace('Hourly', ''))|| 0);
