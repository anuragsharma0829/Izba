...
let updatetoggleSwitch;
  ...
  // )
    // .then((response) => response.json())
    // .then((data) => {
      document.getElementById("updateRateCard").value = item.Rate_Card_Name;
      document.getElementById("updateCarrierType").value = item.Carrier_Type;
      if (item.Brand_Contract) {
      ...
      rateCradNameforupdate = item.Rate_Card_Name;
      updateCarrierType = item.Carrier_Type;
      updatetoggleSwitch = item.Brand_Contract;
