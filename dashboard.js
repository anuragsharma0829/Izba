...
function handleRateCardClick(objectId) {
  ...
  if (existingService) {
    ...
    var upActionButtons = document.createElement("div");
    upActionButtons.className = "upAction-buttons";
    upActionButtons.style.alignItems = "center";
    upActionButtons.style.cursor = "pointer";

    var upButton = document.createElement("i");
    upButton.className = "fa-solid fa-square-chevron-up";
    upActionButtons.appendChild(upButton);
