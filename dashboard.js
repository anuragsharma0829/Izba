...
function handleRateEdit(objectId) {
 let ratecardID = {
  ...
  console.log("display data of item ", ratecardID);
  
  // update rateCards
let rateCradNameforupdate;
let updateCarrierType;
let updatetoggleSwitch;
  ...
  // )
    // .then((response) => response.json())
    // .then((data) => {
      document.getElementById("updateRateCard").value = ratecardID.Rate_Card_Name;
      document.getElementById("updateCarrierType").value = ratecardID.Carrier_Type;
      if (ratecardID.Brand_Contract) {
      ...
      rateCradNameforupdate = ratecardID.Rate_Card_Name;
      updateCarrierType = ratecardID.Carrier_Type;
      updatetoggleSwitch = ratecardID.Brand_Contract;
      console.log(rateCradNameforupdate);
      console.log(updateCarrierType);
      console.log(updatetoggleSwitch);
      ...
      $("#updaterateCard").click(function () {
        ...
        updateCarrierType = $("#updateCarrierType").val();
        updatetoggleSwitch = $("#updatetoggleSwitch").val(); 
        let updatetoggleSwitchValue = (updatetoggleSwitch === "true");  
        const updatedData = {
          Rate_Card_ID: {
            objectId: ratecardID.objectId,
          },          
          Rate_Card_Name: rateCradNameforupdate,
          Carrier_Type: updateCarrierType,
          Brand_Contract: updatetoggleSwitchValue,
        };
...
$(document).ready(function () {
  $("#addRCcardbtn").click(function () {
    ...
    if (ratecarName !== "" && Carrier_Type !== "" && Brand_Contract !== "" ) {
      ...
      console.log("data =====", ratecardDetail);
      fetch(
